...
main = hspec $ do
  ...
  describe "Shopping Cart pricing rules" $ do
    it "finds rules for a customer" $
      ...
      `shouldBe` Checkout (fromList [(Classic, PriceDrop 70)]) (fromList [(Classic, PriceQty 100 1)])
